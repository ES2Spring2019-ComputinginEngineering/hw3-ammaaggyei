...
# NUMBER OF HOURS TO COMPLETE: 1 HR
# YOUR COLLABORATION STATEMENT(s):
# I worked alone but go the Decimal import idea from the url link https://docs.python.org/3/tutorial/floatingpoint.html
#
#*****************************************
